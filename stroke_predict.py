...
rightdatafilename = './stroke_data/'+ selectStroke + '_right.txt'
reversedatafilename = './stroke_data/'+ selectStroke + '_reverse.txt'
differdatafilename = './stroke_data/'+ differStroke + '_right.txt'

modelname = './stroke_model/'+ model_type+ '.h5'
...
print("검사 모델: ", selectStroke)
if select == 1:
    print("선택한 유형: ", selectStroke, "정방향")
elif select == 2:
    print("선택한 유형: ", selectStroke, "역방향")
elif select == 3:
    print("선택한 유형: ", differStroke, "정방향")
